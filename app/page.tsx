    ...
    <main dir={isArabic ? "rtl" : "ltr"} className="min-h-screen bg-[#111111] text-white">
      ...
      >
        <Image
          ...
          priority
          sizes="100vw"
          className="hero-dance absolute inset-0 h-full w-full object-cover object-top"
        />
      </section>
...
function MediaPreview({ url, label, thumbnailImage }: { url: string; label: string; thumbnailImage?: string }) {
  ...
  if (!videoId) {
    return (
      <div className="mx-auto flex aspect-[4/5] max-h-[420px] w-full max-w-[336px] items-center justify-center rounded-md bg-black text-white">
